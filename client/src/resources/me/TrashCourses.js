...
function TrashCourses() {
  ...
  const handleAllCourse = (e) => {
    ...
    axios({
      ...
      url: `${REACT_APP_SERVER}/courses/handle-form-actions-trash`
    })
    .then(ketqua => {
  ...
  const deleteCourse = (e) => {
    ...
    axios({
      ...
      data: {},
      withCredentials: true,
      url: `${REACT_APP_SERVER}/courses/${courseId}/force`
    })
    .then(ketqua => {
        ...
        <form name="container-form" method="POST" className="mt-4">
          <div>
            ...
            <div className="mt-4 mb-2 d-flex align-items-center">
              ...
              <Link to="/me/stored/courses" className="btn btn-primary btn-sm ml-auto mr-2" title="Danh sách khóa học"><i className="fas fa-undo"></i>  Danh sách khóa học</Link>
            </div>
          </div>
        ...
        <div className="modal-dialog" role="document">
          <div className="modal-content">
            ...
            <div className="modal-footer">
              ...
              <button id="btn-deleteall-course" type="button" className="btn btn-danger"  onClick={deleteCourse}>Thực hiện</button>
            </div>
          </div>
        </div>
      </div>
